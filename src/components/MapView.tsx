...
export default function MapView({
  ...
  return (
    <div className="relative w-full h-full min-h-[380px] sm:min-h-[450px] bg-slate-950 rounded-2xl overflow-hidden border border-slate-800 shadow-2xl flex flex-col font-sans">
      {/* Header Overlay */}
      <div className="p-2.5 sm:p-3 bg-slate-900/95 backdrop-blur-md border-b border-slate-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 z-10">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-400 hidden sm:block">{stops.length} Property Showing Stops · Long Island</p>
          </div>
        </div>

        <div className="flex items-center justify-between w-full sm:w-auto gap-2">
          {/* Toggle Map Mode */}
          <div className="flex bg-slate-950 p-0.5 rounded-lg border border-slate-800 text-[10px] sm:text-[11px] font-bold">
            <button
      ...
      <div className="px-3 py-1.5 bg-slate-900/80 border-b border-slate-800/80 flex items-center gap-1.5 overflow-x-auto no-scrollbar z-10">

...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-950 border-t border-slate-800 text-slate-400 text-xs py-8 px-4 font-sans">
      <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="font-black text-white text-xs tracking-tight">MLSTourPlanner</span>
          <span className="text-slate-600">|</span>
          <span className="text-[11px] text-slate-400">Automated Real Estate Showing Itinerary & Route Optimizer</span>
        </div>
